...
void sigtran_start() {
  ...
  osmo_ss7_asp_set_peer(asp, "192.168.1.66", 2905);
  ...
  as = osmo_ss7_as_create(ss7, "as-tcap", OSMO_SS7_AS_TMODE_OVERRIDE, 0, NULL);

  if (!as) {
    printf("AS create failed\n");
    return;
  }

  osmo_ss7_as_add_asp(as, asp);
